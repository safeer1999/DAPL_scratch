...
def main() :
	...
	Dataset = DataHandler(args.input_file, mask_given = args.set_mask, missing_perc = args.missing_perc)
	model = DAPL(learning_rate = args.lr , epochs = args.epochs , shape = Dataset.R.shape)
	model.init_tensors()
